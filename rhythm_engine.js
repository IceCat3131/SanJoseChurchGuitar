...
if (!raw.length)
return { ...(pattern || {}), time_signature: meter, subdivision: 8, events: [] };
...
if (type === 'arpeggio') {
if (idx === 0 || String(step).toUpperCase() === 'R')
role = 'bass';
else if (idx % 4 === 1)
role = 'mid1';
else if (idx % 4 === 2)
